...
execute if block ~ ~1 ~ water positioned ^ ^ ^0.25 unless entity @e[distance=..0.5] positioned ~ ~ ~ run function sg:guns/ak47/ak47_ray
execute if block ~ ~1 ~ air positioned ^ ^ ^0.25 unless entity @e[distance=..0.5] positioned ~ ~ ~ run function sg:guns/ak47/ak47_ray
