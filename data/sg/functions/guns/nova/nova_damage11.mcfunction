...
execute if block ~ ~1 ~ water positioned ^ ^ ^0.5 unless entity @e[distance=..0.65] positioned ~ ~ ~ run function sg:guns/nova/nova_ray12
execute if block ~ ~1 ~ air positioned ^ ^ ^0.5 unless entity @e[distance=..0.65] positioned ~ ~ ~ run function sg:guns/nova/nova_ray12
