...
execute if block ~ ~ ~ water positioned ^ ^ ^0.5 unless entity @e[distance=..0.25] positioned ~ ~ ~ run function sg:guns/nova/nova_damage15
execute if block ~ ~ ~ air positioned ^ ^ ^0.5 unless entity @e[distance=..0.25] positioned ~ ~ ~ run function sg:guns/nova/nova_damage15
