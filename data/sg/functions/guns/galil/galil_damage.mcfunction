...
execute if block ~ ~1 ~ water positioned ^ ^ ^ unless entity @e[distance=..0.5] positioned ~ ~ ~ run function sg:guns/galil/galil_ray
execute if block ~ ~1 ~ air positioned ^ ^ ^ unless entity @e[distance=..0.5] positioned ~ ~ ~ run function sg:guns/galil/galil_ray
