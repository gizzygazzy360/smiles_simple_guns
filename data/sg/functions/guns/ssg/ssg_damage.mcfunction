...
execute positioned ~ ~-1.75 ~ as @e[type=zombie,distance=..0.4] run effect give @s instant_health 1 1 true
...
execute if block ~ ~1 ~ water positioned ^ ^ ^0.25 unless entity @e[distance=..0.5] positioned ~ ~ ~ run function sg:guns/ssg/ssg_ray
execute if block ~ ~1 ~ air positioned ^ ^ ^0.25 unless entity @e[distance=..0.5] positioned ~ ~ ~ run function sg:guns/ssg/ssg_ray
