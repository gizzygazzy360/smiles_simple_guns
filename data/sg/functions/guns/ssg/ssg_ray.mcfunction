...
execute if block ~ ~ ~ #sg:passable positioned ^ ^ ^0.5 unless entity @e[distance=..0.25] positioned ~ ~ ~ run function sg:guns/ssg/ssg_damage
execute if block ~ ~ ~ #minecraft:planks positioned ^ ^ ^0.5 unless entity @e[distance=..0.25] positioned ~ ~ ~ run function sg:guns/ssg/ssg_damage
execute if block ~ ~ ~ #minecraft:signs positioned ^ ^ ^0.5 unless entity @e[distance=..0.25] positioned ~ ~ ~ run function sg:guns/ssg/ssg_damage
execute if block ~ ~ ~ #minecraft:slabs positioned ^ ^ ^0.5 unless entity @e[distance=..0.25] positioned ~ ~ ~ run function sg:guns/ssg/ssg_damage
execute if block ~ ~ ~ #minecraft:wooden_doors positioned ^ ^ ^0.5 unless entity @e[distance=..0.25] positioned ~ ~ ~ run function sg:guns/ssg/ssg_damage
execute if block ~ ~ ~ #minecraft:buttons positioned ^ ^ ^0.5 unless entity @e[distance=..0.25] positioned ~ ~ ~ run function sg:guns/ssg/ssg_damage
execute if block ~ ~ ~ #sg:plants positioned ^ ^ ^0.5 unless entity @e[distance=..0.25] positioned ~ ~ ~ run function sg:guns/ssg/ssg_damage
execute if block ~ ~ ~ #minecraft:wool positioned ^ ^ ^0.5 unless entity @e[distance=..0.25] positioned ~ ~ ~ run function sg:guns/ssg/ssg_damage

execute if block ~ ~ ~ water positioned ^ ^ ^0.5 unless entity @e[distance=..0.25] positioned ~ ~ ~ run function sg:guns/ssg/ssg_damage
execute if block ~ ~ ~ air positioned ^ ^ ^0.5 unless entity @e[distance=..0.25] positioned ~ ~ ~ run function sg:guns/ssg/ssg_damage
