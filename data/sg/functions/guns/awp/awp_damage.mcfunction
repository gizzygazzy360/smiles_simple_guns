...
execute positioned ~ ~-1.15 ~ as @e[type=zombie,distance=..0.65] run effect give @s instant_health 1 2 true
...
execute if block ~ ~1 ~ water unless entity @e[distance=..0.5] positioned ~ ~ ~ run function sg:guns/awp/awp_ray
execute if block ~ ~1 ~ air unless entity @e[distance=..0.5] positioned ~ ~ ~ run function sg:guns/awp/awp_ray
